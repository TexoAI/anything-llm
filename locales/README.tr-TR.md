...
<p align="center">
<b>Codex:</b> Aradığınız hepsi bir arada yapay zeka uygulaması.<br />
...
<p align="center">  
👉 Masaüstü için Codex (Mac, Windows ve Linux)! <a href="https://codex.com/download" target="_blank"> Şimdi İndir</a>  
</p>  
...
![Mesajlaşma](https://github.com/Dimatic-Labs/codex/assets/16845892/cfc5f47c-bd91-4067-986c-f3f49621a859)
...
- 💬 [Web sitenize gömülebilir özel sohbet aracı](https://github.com/Dimatic-Labs/codex-embed/blob/main/README.md) _(Yalnızca Docker sürümünde)_  
...
- **`embed`**: [Web gömme widget’ı](https://github.com/Dimatic-Labs/codex-embed) oluşturma ve entegrasyonu için alt modül.  
- **`browser-extension`**: [Chrome tarayıcı eklentisi](https://github.com/Dimatic-Labs/codex-extension) için alt modül.

## 🛳 Kendi Sunucunuzda Barındırma  

Dimatic ve topluluk, Codex'i yerel olarak çalıştırmak için çeşitli dağıtım yöntemleri, betikler ve şablonlar sunmaktadır. Aşağıdaki tabloya göz atarak tercih ettiğiniz ortamda nasıl dağıtım yapabileceğinizi öğrenebilir veya otomatik dağıtım seçeneklerini keşfedebilirsiniz.
...
[veya Docker kullanmadan üretim ortamında Codex kurun →](../BARE_METAL.md)  
...
_Bu uygulamalar Dimatic tarafından yönetilmemektedir, ancak Codex ile uyumludur. Burada listelenmeleri bir onay anlamına gelmez._  

- [Midori AI Alt Sistem Yöneticisi](https://io.midori-ai.xyz/subsystem/codex/) - Docker konteyner teknolojisini kullanarak yapay zeka sistemlerini verimli bir şekilde dağıtmanın pratik bir yolu.  
- [Coolify](https://coolify.io/docs/services/codex/) - Tek tıklamayla Codex dağıtımı yapmanıza olanak tanır.  
- [GPTLocalhost for Microsoft Word](https://gptlocalhost.com/demo/) - Codex’i Microsoft Word içinde kullanmanıza olanak tanıyan yerel bir Word eklentisi.

## Telemetri ve Gizlilik  

Dimatic Inc. tarafından geliştirilen Codex, anonim kullanım bilgilerini toplayan bir telemetri özelliği içermektedir.  

<details>  
<summary><kbd>Codex için Telemetri ve Gizlilik hakkında daha fazla bilgi</kbd></summary>  

### Neden?  

Bu bilgileri, Codex’in nasıl kullanıldığını anlamak, yeni özellikler ve hata düzeltmelerine öncelik vermek ve uygulamanın performansını ve kararlılığını iyileştirmek için kullanıyoruz.  
...
[Kaynak kodda tüm telemetri olaylarını görüntüle](https://github.com/search?q=repo%3ADimatic-Labs%2Fcodex%20.sendTelemetry\(&type=code)
...
Telif Hakkı © 2025 [Dimatic][profile-link]. <br />  
