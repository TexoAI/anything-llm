...
const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Welkom bij Codex, Codex is een open-source AI-tool van Dimatic die alles omzet in een getrainde chatbot waarmee je kunt vragen en chatten. Codex is een BYOK (bring-your-own-keys) software, dus er is geen abonnement, vergoeding of kosten voor deze software buiten de diensten die je ermee wilt gebruiken.",
    part2:
      "Codex is de eenvoudigste manier om krachtige AI-producten zoals OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB en andere diensten samen te voegen in een net pakket zonder gedoe om je productiviteit met 100x te verhogen.",
    part3:
      "Codex kan volledig lokaal op je machine draaien met weinig overhead, je merkt niet eens dat het er is! Geen GPU nodig. Cloud en on-premises installatie is ook beschikbaar.\nHet AI-tooling ecosysteem wordt elke dag krachtiger. Codex maakt het gemakkelijk te gebruiken.",
  ...
  api: {
    title: "API-sleutels",
    description:
      "API-sleutels stellen de houder in staat om deze Codex-instantie programmatisch te openen en beheren.",
  ...
  llm: {
    title: "LLM Voorkeur",
    description:
      "Dit zijn de inloggegevens en instellingen voor je voorkeurs LLM-chat & inbeddingprovider. Het is belangrijk dat deze sleutels actueel en correct zijn, anders zal Codex niet goed werken.",
  ...
  transcription: {
    ...
    "warn-start":
      "Het gebruik van het lokale fluistermodel op machines met beperkte RAM of CPU kan Codex vertragen bij het verwerken van mediabestanden.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Inbedding is het proces van het omzetten van tekst in vectoren. Deze inloggegevens zijn vereist om je bestanden en prompts om te zetten naar een formaat dat Codex kan gebruiken om te verwerken.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Dit zijn de inloggegevens en instellingen voor hoe je Codex-instantie zal functioneren. Het is belangrijk dat deze sleutels actueel en correct zijn.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Dit is je configuratie voor hoe verbonden derden en Codex je gegevens verwerken.",
    llm: "LLM Selectie",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Bescherm je Codex-instantie met een wachtwoord. Als je dit vergeet, is er geen herstelmethode, dus zorg ervoor dat je dit wachtwoord opslaat.",
