const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Codex can work with many LLM providers. This will be the service which handles chatting.",
    },
    userSetup: {
      title: "User Setup",
    ...
    survey: {
      ...
      description: "Help us make Codex built for your needs. Optional.",

      email: "What's your email?",
      useCase: "What will you use Codex for?",
      useCaseWork: "For work",
      useCasePersonal: "For personal use",
      useCaseOther: "Other",
      comment: "How did you hear about Codex?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "Create your first workspace and get started with Codex.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Welcome to Codex, Codex turns anything into a trained chatbot you can query and chat with.",
    part2:
      "Codex puts powerful AI services together in a neat package with no fuss to increase your productivity.",
    user1: "How do I get started?!",
    part3:
      "It's simple. All collections are organised into buckets we call \"Workspaces\". Workspaces are buckets of files, documents, images, PDFs, and other files which will be transformed into something AI can understand and use in conversation.\n\nYou can add and remove files at anytime.",
    ...
    part4:
      "Codex is more than a smarter Dropbox.\n\nCodex offers two ways of talking with your data:\n\n<i>Query:</i> Your chats will return information found in the documents in your workspace. Adding more documents to the Workspace make it smarter! \n\n<i>Conversational:</i> Your documents + your on-going chat history both contribute to the AI knowledge at the same time. Great for appending real-time text-based info or corrections and misunderstandings the AI might have. \n\nYou can toggle between either mode \n<i>in the middle of chatting!</i>",
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "You're on your way to becoming an Codex expert!",
      dismiss: "close",
      tasks: {
        create_workspace: {
  ...
  customization: {
    interface: {
      ...
      description: "Set your UI preferences for Codex.",
    },
    branding: {
      title: "Branding & Whitelabeling",
      description:
        "White-label your Codex instance with custom branding.",
    },
    chat: {
      title: "Chat",
      description: "Set your chat preferences for Codex.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Select the preferred language to render Codex's UI in - when translations are available.",
      },
      logo: {
        title: "Brand Logo",
      ...
      "welcome-messages": {
        ...
        user: "user",
        message: "message",
        assistant: "Codex Chat Assistant",
  ...
  api: {
    title: "API Keys",
    description:
      "API keys allow the holder to programmatically access and manage this Codex instance.",
  ...
  llm: {
    title: "LLM Preference",
    description:
      "These are the credentials and settings for your preferred LLM chat & embedding provider. It is important that these keys are current and correct, or else Codex will not function properly.",
  ...
  transcription: {
    ...
    "warn-start":
      "Using the local whisper model on machines with limited RAM or CPU can stall Codex when processing media files.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding is the process of turning text into vectors. These credentials are required to turn your files and prompts into a format which Codex can use to process.",
    provider: {
  ...
  vector: {
    ...
    description:
      "These are the credentials and settings for how your Codex instance will function. It's important these keys are current and correct.",
    provider: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protect your Codex instance with a password. If you forget this there is no recovery method so ensure you save this password.",
  ...
  privacy: {
    ...
    description:
      "This is your configuration for how connected third party providers and Codex handle your data.",
    llm: "LLM Selection",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "These files will be uploaded to the document processor running on this Codex instance. These files are not sent or shared with a third party.",
    },
    pinning: {
      what_pinning: "What is document pinning?",
      pin_explained_block1:
        "When you <b>pin</b> a document in Codex we will inject the entire content of the document into your prompt window for your LLM to fully comprehend.",
      pin_explained_block2:
        "This works best with <b>large-context models</b> or small files that are critical to its knowledge-base.",
      pin_explained_block3:
        "If you are not getting the answers you desire from Codex by default then pinning is a great way to get higher quality answers in a click.",
      accept: "Okay, got it",
    },
    watching: {
      what_watching: "What does watching a document do?",
      watch_explained_block1:
        "When you <b>watch</b> a document in Codex we will <i>automatically</i> sync your document content from it's original source on regular intervals. This will automatically update the content in every workspace where this file is managed.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "You need to authenticate with the Codex Community Hub before publishing items.",
