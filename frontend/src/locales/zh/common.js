...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      title: "LLM 偏好",
      description:
        "Codex 可以与多家 LLM 提供商合作。这将是处理聊天的服务。",
    },
    userSetup: {
      title: "用户设置",
    ...
    survey: {
      title: "欢迎使用 Codex",
      description: "帮助我们为你的需求打造 Codex。可选。",
      email: "你的电子邮件是什么？",
      useCase: "你将如何使用 Codex？",
      useCaseWork: "用于工作",
      useCasePersonal: "用于个人使用",
      useCaseOther: "其他",
      comment: "你是如何听说 Codex 的？",
      commentPlaceholder:
    ...
    workspace: {
      title: "创建你的第一个工作区",
      description: "创建你的第一个工作区并开始使用 Codex。",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "欢迎使用 Codex，这是由 Dimatic 开发的开源 AI 工具，可以将任何东西转换为你可以查询和聊天的训练有素的聊天机器人。Codex 是一款 BYOK（自带密钥）软件，因此除了你想使用的服务外，此软件不收取订阅费、费用或其他费用。",
    part2:
      "Codex 是将强大的 AI 产品（如 OpenAi、GPT-4、LangChain、PineconeDB、ChromaDB 等）整合在一个整洁的包中而无需繁琐操作的最简单方法，可以将你的生产力提高 100 倍。",
    part3:
      "Codex 可以完全在你的本地计算机上运行，几乎没有开销，你甚至不会注意到它的存在！无需 GPU。也可以进行云端和本地安装。\nAI 工具生态系统每天都在变得更强大。Codex 使其易于使用。",
  ...
  customization: {
    interface: {
      title: "界面偏好设置",
      description: "设置您的 Codex 界面偏好。",
    },
    branding: {
      title: "品牌与白标设置",
      description: "使用自定义品牌对白标您的 Codex 实例。",
    },
    chat: {
      title: "聊天",
      description: "设置您的 Codex 聊天偏好。",
      auto_submit: {
        title: "自动提交语音输入",
    ...
    items: {
      ...
      "display-language": {
        title: "显示语言",
        description: "选择显示 Codex 界面所用的语言（若有翻译可用）。",
      },
      logo: {
        title: "品牌标志",
  ...
  api: {
    title: "API 密钥",
    description: "API 密钥允许持有者以编程方式访问和管理此 Codex 实例。",
    link: "阅读 API 文档",
  ...
  llm: {
    title: "LLM 首选项",
    description:
      "这些是你首选的 LLM 聊天和嵌入提供商的凭据和设置。重要的是，确保这些密钥是最新的和正确的，否则 Codex 将无法正常运行。",
    provider: "LLM 提供商",
    providers: {
      azure_openai: {
  ...
  transcription: {
    ...
    provider: "转录提供商",
    "warn-start":
      "在 RAM 或 CPU 有限的计算机上使用本地耳语模型可能会在处理媒体文件时停止 Codex。",
  ...
  embedding: {
    ...
    "desc-end":
      "嵌入是将文本转换为矢量的过程。需要这些凭据才能将你的文件和提示转换为 Codex 可以用来处理的格式。",
    provider: {
      title: "嵌入引擎提供商",
    },
  },
  ...
  vector: {
    title: "向量数据库",
    description:
      "这些是 Codex 实例如何运行的凭据和设置。重要的是，这些密钥是最新的和正确的。",
    provider: {
      title: "向量数据库提供商",
  ...
  connectors: {
    ...
    upload: {
      ...
      "fetch-website": "获取网站",
      "privacy-notice":
        "这些文件将被上传到此 Codex 实例上的文档处理器。这些文件不会发送或共享给第三方。",
    },
    pinning: {
      what_pinning: "什么是文档固定？",
      pin_explained_block1:
        "当您在 Codex 中<b>固定</b>一个文档时，我们会将整个文档内容注入到您的提示窗口中，让 LLM 能够完全理解它。",
      pin_explained_block2:
        "这在 <b>大上下文模型</b> 或关键的小文件中效果最佳。",
      pin_explained_block3:
        "如果默认情况下无法从 Codex 获取满意的答案，固定文档是提高答案质量的好方法。",
      accept: "好的，知道了",
    },
    watching: {
      what_watching: "什么是监控文档？",
      watch_explained_block1:
        "当您在 Codex 中<b>监控</b>一个文档时，我们会<i>自动</i>按定期间隔从其原始来源同步文档内容。系统会自动更新在所有使用该文档的工作区中的内容。",
  ...
  security: {
    ...
    password: {
      title: "密码保护",
      description:
        "用密码保护你的Codex实例。如果你忘记了密码，那么没有恢复方法，所以请确保保存这个密码。",
      "password-label": "实例密码",
    },
  },
};
