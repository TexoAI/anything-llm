...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Codex var strādāt ar daudziem LLM pakalpojumu sniedzējiem. Šis būs pakalpojums, kas apstrādās sarunas.",
    },
    userSetup: {
    ...
    survey: {
      title: "Laipni lūgti Codex",
      description:
        "Palīdziet mums veidot Codex atbilstoši jūsu vajadzībām. Neobligāti.",
      email: "Kāds ir jūsu e-pasts?",
      useCase: "Kam izmantosiet Codex?",
      useCaseWork: "Darbam",
      useCasePersonal: "Personīgai lietošanai",
      useCaseOther: "Citam nolūkam",
      comment: "Kā jūs uzzinājāt par Codex?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "Izveidojiet savu pirmo darba telpu un sāciet darbu ar Codex.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Laipni lūgti Codex, Codex ir Dimatic izstrādāts atvērtā koda AI rīks, kas pārvērš jebko par apmācītu čatbotu, kuru varat izmantot vaicājumiem un sarunām. Codex ir BYOK (bring-your-own-keys) programmatūra, tāpēc nav abonēšanas, maksas vai papildu maksājumu par šo programmatūru, izņemot pakalpojumus, kurus vēlaties izmantot ar to.",
    part2:
      "Codex ir vienkāršākais veids, kā apvienot spēcīgus AI produktus, piemēram, OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB un citus pakalpojumus, kārtīgā paketē bez liekas piepūles, lai palielinātu savu produktivitāti 100 reizes.",
    part3:
      "Codex var darboties pilnībā lokāli jūsu datorā ar minimālu piepūli, jūs pat nepamanīsiet tā klātbūtni! GPU nav nepieciešams. Pieejama arī mākoņa un lokālā instalācija.\nAI rīku ekosistēma kļūst spēcīgāka ar katru dienu. Codex to padara viegli izmantojamu.",
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "Jūs esat ceļā, lai kļūtu par Codex ekspertu!",
      dismiss: "aizvērt",
      tasks: {
        create_workspace: {
  ...
  customization: {
    interface: {
      ...
      description: "Iestatiet savas UI preferences Codex.",
    },
    branding: {
      title: "Zīmolrade un identitāte",
      description:
        "Pielāgojiet savu Codex instanci ar pielāgotu zīmolradi.",
    },
    chat: {
      title: "Saruna",
      description: "Iestatiet savas sarunas preferences Codex.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Izvēlieties vēlamo valodu Codex lietotāja saskarnei - kad pieejami tulkojumi.",
      },
      logo: {
      ...
      "welcome-messages": {
        ...
        user: "lietotājs",
        message: "ziņojums",
        assistant: "Codex čata asistents",
  ...
  api: {
    title: "API atslēgas",
    description:
      "API atslēgas ļauj to īpašniekam programmatiski piekļūt un pārvaldīt šo Codex instanci.",
  ...
  llm: {
    title: "LLM preferences",
    description:
      "Šie ir akreditācijas dati un iestatījumi jūsu vēlamajam LLM čata un iegulšanas pakalpojuma sniedzējam. Ir svarīgi, lai šīs atslēgas būtu aktuālas un pareizas, pretējā gadījumā Codex nedarbosies pareizi.",
  ...
  transcription: {
    ...
    "warn-start":
      "Izmantojot lokālo whisper modeli iekārtās ar ierobežotu RAM vai CPU var apstādināt Codex, apstrādājot multivides failus.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Iegulšana ir process, ar kuru teksts tiek pārveidots vektoros. Šie akreditācijas dati ir nepieciešami, lai pārveidotu jūsu failus un vaicājumus formātā, kuru Codex var izmantot apstrādei.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Šie ir akreditācijas dati un iestatījumi tam, kā darbosies jūsu Codex instance. Ir svarīgi, lai šīs atslēgas būtu aktuālas un pareizas.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Šī ir jūsu konfigurācija tam, kā savienotie trešo pušu pakalpojumu sniedzēji un Codex apstrādā jūsu datus.",
    llm: "LLM izvēle",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Šie faili tiks augšupielādēti dokumentu apstrādātājā, kas darbojas šajā Codex instancē. Šie faili netiek nosūtīti vai kopīgoti ar trešo pusi.",
    },
    pinning: {
      what_pinning: "Kas ir dokumentu piespraušana?",
      pin_explained_block1:
        "Kad jūs <b>piespraudiet</b> dokumentu Codex, mēs ievietosim visu dokumenta saturu jūsu uzvednes logā, lai jūsu LLM to pilnībā saprastu.",
      pin_explained_block2:
        "Tas vislabāk darbojas ar <b>liela konteksta modeļiem</b> vai maziem failiem, kas ir kritiski tā zināšanu bāzei.",
      pin_explained_block3:
        "Ja jūs nesaņemat vēlamās atbildes no Codex pēc noklusējuma, tad piespraušana ir lielisks veids, kā iegūt kvalitatīvākas atbildes ar vienu klikšķi.",
      accept: "Labi, sapratu",
    },
    watching: {
      what_watching: "Ko dara dokumenta novērošana?",
      watch_explained_block1:
        "Kad jūs <b>novērojat</b> dokumentu Codex, mēs <i>automātiski</i> sinhronizēsim jūsu dokumenta saturu no tā sākotnējā avota regulāros intervālos. Tas automātiski atjauninās saturu katrā darba vietā, kur šis fails tiek pārvaldīts.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Aizsargājiet savu Codex instanci ar paroli. Ja aizmirsīsiet šo paroli, nav atgūšanas metodes, tāpēc pārliecinieties, ka saglabājat šo paroli.",
