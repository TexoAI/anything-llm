...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Codex poate funcționa cu mai mulți furnizori LLM. Acesta va fi serviciul care gestionează conversațiile.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bun venit la Codex",
      description:
        "Ajută-ne să facem Codex potrivit pentru nevoile tale. Opțional.",
      email: "Care este adresa ta de email?",
      useCase: "Pentru ce vei folosi Codex?",
      useCaseWork: "Pentru muncă",
      useCasePersonal: "Pentru uz personal",
      useCaseOther: "Altele",
      comment: "De unde ai aflat despre Codex?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "Creează primul tău spațiu de lucru și începe să folosești Codex.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Bine ai venit la Codex, Codex este un instrument AI open-source creat de Dimatic care transformă orice într-un chatbot antrenat cu care poți interacționa. Codex este un software BYOK (bring-your-own-keys) fără abonamente sau taxe în afară de serviciile pe care dorești să le folosești.",
    part2:
      "Codex este cea mai simplă modalitate de a combina produse AI puternice precum OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB și alte servicii într-un pachet ordonat care îți crește productivitatea de 100x.",
    part3:
      "Codex poate rula complet local pe calculatorul tău cu un consum redus de resurse, pe care nici nu îl vei observa! Nu este necesar GPU. Instalarea în cloud sau local este, de asemenea, disponibilă.\nEcosistemul de unelte AI devine tot mai puternic zilnic. Codex face aceste tehnologii ușor de folosit.",
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "Ești pe drumul să devii expert Codex!",
      dismiss: "închide",
      tasks: {
        create_workspace: {
  ...
  vector: {
    ...
    description:
      "Acestea sunt credențialele și setările pentru modul în care funcționează instanța ta Codex. Este important să fie corecte și actuale.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Aceasta este configurația ta pentru modul în care furnizorii terți conectați și Codex gestionează datele tale.",
    llm: "Selecția LLM",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Aceste fișiere vor fi încărcate în procesorul de documente care rulează pe această instanță Codex. Aceste fișiere nu sunt trimise sau partajate cu o terță parte.",
    },
    pinning: {
      what_pinning: "Ce este fixarea documentelor?",
      pin_explained_block1:
        "Când **fixezi** un document în Codex, vom injecta întregul conținut al documentului în fereastra de prompt pentru ca LLM-ul tău să-l înțeleagă pe deplin.",
      ...
      pin_explained_block3:
        "Dacă nu obții răspunsurile dorite de la Codex în mod implicit, atunci fixarea este o modalitate excelentă de a obține răspunsuri de calitate superioară dintr-un clic.",
      accept: "Ok, am înțeles",
    },
    watching: {
      what_watching: "Ce face vizualizarea unui document?",
      watch_explained_block1:
        "Când **urmărești** un document în Codex, vom sincroniza *automat* conținutul documentului tău din sursa originală la intervale regulate. Acest lucru va actualiza automat conținutul în fiecare spațiu de lucru unde acest fișier este gestionat.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Trebuie să te autentifici cu Codex Community Hub înainte de a publica elemente.",
  ...
  customization: {
    interface: {
      title: "Preferințe UI",
      description: "Setează preferințele UI pentru Codex.",
    },
    branding: {
      title: "Branding & White-labeling",
      description:
        "Personalizează-ți instanța Codex cu branding personalizat.",
    },
    chat: {
      title: "Chat",
      description: "Setează preferințele de chat pentru Codex.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Selectează limba preferată pentru a reda interfața Codex - atunci când traducerile sunt disponibile.",
      },
      logo: {
        title: "Logo brand",
        description:
  ...
  api: {
    title: "Chei API",
    description:
      "Cheile API permit deținătorului să acceseze și să gestioneze programatic această instanță Codex.",
  ...
  llm: {
    title: "Preferința LLM",
    description:
      "Acestea sunt credențialele și setările pentru furnizorul tău preferat de chat și embedding LLM. Este important ca aceste chei să fie actuale și corecte, altfel Codex nu va funcționa corect.",
  ...
  transcription: {
    ...
    "warn-start":
      "Utilizarea modelului local Whisper pe mașini cu RAM sau CPU limitat poate bloca Codex la procesarea fișierelor media.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding-ul este procesul de transformare a textului în vectori. Aceste credențiale sunt necesare pentru a transforma fișierele și prompturile dvs. într-un format pe care Codex îl poate utiliza pentru procesare.",
    provider: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protejează instanța Codex cu o parolă. Dacă o uiți, nu există metode de recuperare, deci asigură-te că o salvezi.",
