...
export default function DefaultChatContainer() {
  ...
  const popMsg = !window.localStorage.getItem("codex_intro");
  ...
  useEffect(() => {
    function processMsgs() {
      if (!!window.localStorage.getItem("codex_intro")) {
      ...
      window.localStorage.setItem("codex_intro", 1);
    }
