...
const SHOW_METRICS_KEY = "codex_show_chat_metrics";
const SHOW_METRICS_EVENT = "codex_show_metrics_change";
...
/**
 * Get the show metrics setting from localStorage `codex_show_chat_metrics` key
 * @returns {boolean}
 */
...
/**
 * Toggle the show metrics setting in localStorage `codex_show_chat_metrics` key
 * @returns {void}
 */
