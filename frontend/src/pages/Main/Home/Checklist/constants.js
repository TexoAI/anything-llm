...
export const CHECKLIST_UPDATED_EVENT = "codex_checklist_updated";
export const CHECKLIST_STORAGE_KEY = "codex_checklist_completed";
export const CHECKLIST_HIDDEN = "codex_checklist_dismissed";
