...
function FeatureVerification({ children }) {
  if (
    !window.localStorage.getItem("codex_tos_experimental_feature_set")
  ) {
    function acceptTos(e) {
      e.preventDefault();

      window.localStorage.setItem(
        "codex_tos_experimental_feature_set",
        "accepted"
      );
      showToast(
            ...
            <form onSubmit={acceptTos}>
              <div className="py-7 px-9 space-y-4 flex-col">
                <div className="w-full text-white text-md flex flex-col gap-y-4">
                  <p>
                    Experimental features of Codex are features that we
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-6 text-sm font-mono mt-2">
                      ...
                      <li>Potential bugs or issues using Codex.</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-6 text-sm font-mono mt-2">
                      ...
                      <li>
                        ...
                        configurations, or subscriptions of Codex.
                      </li>
                      <li>
                  ...
                  <p>
                    ...
                    <a
                      href="https://docs.codex.com/beta-preview/overview"
