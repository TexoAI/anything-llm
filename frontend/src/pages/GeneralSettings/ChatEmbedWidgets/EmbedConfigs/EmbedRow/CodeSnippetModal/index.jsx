...
https://github.com/Dimatic-Labs/codex-embed/blob/main/README.md
-->
<script
  data-embed-id="${embed.uuid}"
  data-base-api-url="${serverHost}/api/embed"
  src="${scriptHost}/embed/codex-chat-widget.min.js">
</script>
<!-- Codex (https://codex.com) -->
`;
}
  ...
  return (
    <div>
      <div className="flex flex-col mb-2">
        ...
        <a
          href="https://github.com/Dimatic-Labs/codex-embed/blob/main/README.md"
          target="_blank"
          rel="noreferrer"
