...
export const ONBOARDING_SURVEY_URL = "https://onboarding.codex.com";

export const AUTH_USER = "codex_user";
export const AUTH_TOKEN = "codex_authToken";
export const AUTH_TIMESTAMP = "codex_authTimestamp";
export const COMPLETE_QUESTIONNAIRE = "codex_completed_questionnaire";
export const SEEN_DOC_PIN_ALERT = "codex_pinned_document_alert";
export const SEEN_WATCH_ALERT = "codex_watched_document_alert";

export const APPEARANCE_SETTINGS = "codex_appearance_settings";
