...
const System = {
  cacheKeys: {
    footerIcons: "codex_footer_links",
    supportEmail: "codex_support_email",
    customAppName: "codex_custom_app_name",
    canViewChatHistory: "codex_can_view_chat_history",
    deploymentVersion: "codex_deployment_version",
  },
  ping: async function () {
