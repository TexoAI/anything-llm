  ...
  #defaultMeta() {
    return [
      ...
      },
      {
        tag: "title",
        props: null,
        content: "Codex | Your personal LLM trained on anything",
      },
      ...
      {
        tag: "meta",
        props: { property: "og:url", content: "https://codex.com" },
      },
      {
        tag: "meta",
        props: {
      ...
      },
      {
        ...
        props: {
          property: "og:image",
          content:
            "https://raw.githubusercontent.com/Dimatic-Labs/codex/master/images/promo.png",
        },
      },
      ...
      {
        tag: "meta",
        props: { property: "twitter:url", content: "https://codex.com" },
      },
      {
        tag: "meta",
        props: {
    ...
    if (customTitle === null && faviconURL === null) {
      ...
      this.#customConfig = [
        ...
        },
        {
          ...
          content:
            customTitle ??
            "Codex | Your personal LLM trained on anything",
        },
      ];
    }
