# How to setup Pinecone Vector Database for Codex
...
**Note:** [Namespaces are not supported in `gcp-starter` environments](https://docs.pinecone.io/docs/namespaces) and are required to work with Codex.
